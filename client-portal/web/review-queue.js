...
async function resolveItem(documentId,action){
  ...
  if(action==="accept"&&area!=="other"&&!financialYear){alert("Enter the financial year before accepting this document.");return}
  if(action==="accept"&&area==="gst"&&!period){alert("Enter the GST month before accepting this document.");return}
  if(action==="accept"&&area==="tds"&&!period){alert("Enter the TDS quarter before accepting this document.");return}
