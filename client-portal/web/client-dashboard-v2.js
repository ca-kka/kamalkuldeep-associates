...
async function renderClientDashboard(){
  ...
  document.getElementById("client-profile-select")?.addEventListener("change",async e=>{localStorage.setItem(ctx.storageKey,e.target.value);window.dispatchEvent(new CustomEvent("kka-family-profile-change",{detail:{clientId:e.target.value}}));await renderClientDashboard()});
