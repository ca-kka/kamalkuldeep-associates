...
def check(today, expected_payment, expected_q138, expected_q140):
    data = {
        "items": [
            {"title": "TDS Payment", "date": "1 January 2000"},
            {"title": "Form 138 – TDS Return (Salary)", "date": "1 January 2000"},
            {"title": "Form 140 – TDS Return (Non-Salary)", "date": "1 January 2000"},
        ]
    }
...
check(date(2026, 9, 8), "7 October 2026", "31 October 2026", "31 October 2026")

# October 2026 after the 7th: September TDS rolls to 7 November; Q2 returns remain 31 October.
check(date(2026, 10, 8), "7 November 2026", "31 October 2026", "31 October 2026")

# November 2026: October TDS is due 7 December; Q3 returns roll to 31 January 2027.
check(date(2026, 11, 8), "7 December 2026", "31 January 2027", "31 January 2027")
